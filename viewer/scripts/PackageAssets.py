...
def copy_recursive(source_base_path, target_base_path):
    ...
    :param source_base_path: Directory to copy from.
    :param target_base_path: Directory to copy into.
    :return: None
    """
...
# Create a new 'assets' folder to copy the contents in it.
...
copy_recursive(sys.argv[1], target_dir)
